...
Inspired by: GroceryMind — production Talaria agent doing live web research
             across German grocery stores (firecrawl + talaria-agent)
"""
...
# Ensure talaria-agent root is on path
...
class WebResearchEnvConfig(TalariaAgentEnvConfig):
...
class WebResearchEnv(TalariaAgentBaseEnv):
    """
    ...
    async def evaluate(self, *args, **kwargs) -> None:
        ...
        import time
        import uuid
        from environments.agent_loop import TalariaAgentLoop
        from environments.tool_context import ToolContext
