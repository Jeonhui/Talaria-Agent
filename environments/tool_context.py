...
ALL talaria-agent tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all talaria-agent tools for a specific rollout.
    ...
    def upload_file(self, local_path: str, remote_path: str) -> Dict[str, Any]:
        ...
        if len(b64) <= chunk_size:
            ...
            tmp_b64 = "/tmp/_talaria_upload.b64"
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any talaria-agent tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("TALARIA_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("TALARIA_QUIET", None)
            else:
                os.environ["TALARIA_QUIET"] = _prev_quiet
