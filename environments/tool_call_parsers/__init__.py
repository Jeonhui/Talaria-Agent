...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("talaria")
        class TalariaToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "talaria", "mistral", "llama3_json")
...
from environments.tool_call_parsers.talaria_parser import TalariaToolCallParser  # noqa: E402, F401
