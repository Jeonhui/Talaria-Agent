...
Trust levels:
  - builtin:   Ships with Talaria. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.talaria/\.env|\~/\.talaria/\.env',
     "talaria_env_access", "critical", "exfiltration",
     "directly references Talaria secrets file"),
    ...
    (r'\.talaria/config\.yaml|\.talaria/SOUL\.md',
     "talaria_config_mod", "critical", "persistence",
     "references Talaria configuration files directly"),
