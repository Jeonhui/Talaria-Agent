...
$RepoUrlSsh = "git@github.com:Jeonhui/Talaria-Agent.git"
$RepoUrlHttps = "https://github.com/Jeonhui/Talaria-Agent.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
function Install-Repository {
    ...
    if (Test-Path $InstallDir) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                $zipUrl = "https://github.com/Jeonhui/Talaria-Agent/archive/refs/heads/$Branch.zip"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/Jeonhui/Talaria-Agent/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
