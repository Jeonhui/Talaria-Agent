...
# Configuration
REPO_URL_SSH="git@github.com:Jeonhui/Talaria-Agent.git"
REPO_URL_HTTPS="https://github.com/Jeonhui/Talaria-Agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  irm https://raw.githubusercontent.com/Jeonhui/Talaria-Agent/main/scripts/install.ps1 | iex"
            exit 1
            ;;
        *)
            OS="unknown"
