#!/usr/bin/env python3
"""Build the Talaria Skills Index — a centralized JSON catalog of all skills.
...
`talaria skills search/install` can use it without hitting the GitHub API.
...
def main():
    print("Building Talaria Skills Index...", flush=True)
