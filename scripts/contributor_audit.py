...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Talaria\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "talaria@nousresearch.com",
    "talaria-audit@example.com",
    "talaria@habibilabs.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/talaria-agent",
                "--state", "merged",
