...
DEFAULT_DATASETS = [
    ...
    "NousResearch/talaria-agent-megascience-sft1",
    "NousResearch/Talaria-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Talaria-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-talaria-agent"
]
