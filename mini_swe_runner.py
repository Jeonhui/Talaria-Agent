#!/usr/bin/env python3
"""
SWE Runner with Talaria Trajectory Format

A runner that uses Talaria-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Talaria-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Talaria-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Talaria format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Talaria-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Talaria-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Talaria Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Talaria-Agent's built-in execution environments
    and outputs trajectories in Talaria-Agent format.
    """
    ...
    def _convert_to_talaria_format(
        self,
        ...
        """
        Convert internal message format to Talaria trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Talaria trajectory format
        trajectory = self._convert_to_talaria_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Talaria trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Talaria Trajectory Format")
    print("=" * 60)
