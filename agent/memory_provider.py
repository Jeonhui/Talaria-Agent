...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - talaria_home (str): The active TALARIA_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.talaria``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "talaria").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'talaria memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], talaria_home: str) -> None:
        ...
        Called by 'talaria memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``talaria_home`` is the active TALARIA_HOME directory path.
