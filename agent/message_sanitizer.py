"""Message / tool-payload sanitizers extracted from run_agent.

Pure helpers (no AIAgent / module-state dependencies) that scrub lone Unicode
surrogates and repair malformed tool-call JSON before payloads go to a provider.
Extracted from run_agent.py to shrink that module; run_agent re-imports these.
"""
