...
Usage:
    talaria pairing list              # Show all pending + approved users
    talaria pairing approve <platform> <code>  # Approve a pairing code
    talaria pairing revoke <platform> <user_id> # Revoke user access
    talaria pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle talaria pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: talaria pairing {list|approve|revoke|clear-pending}")
        print("Run 'talaria pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'talaria pairing list' to see pending codes.\n")
