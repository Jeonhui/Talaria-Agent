...
- A long-running process (talaria gateway, cron worker) misbehaves and you can't restart it
...
For long-lived processes: Talaria gateway, a daemon, a process that's already misbehaving and can't be restarted clean.
