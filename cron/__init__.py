"""
Cron job scheduling system for Talaria Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    talaria gateway install    # Install as a user service
    sudo talaria gateway install --system  # Linux servers: boot-time system service
    talaria gateway            # Or run in foreground
